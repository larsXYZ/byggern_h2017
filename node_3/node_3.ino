...
unsigned int songList[SONG_COUNT+2][SONG_LENGTH]=
{
  ...
  /*MUTE*/                    ,{R,1000 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0}
  /* STARTUP */               ,{c4,100 ,a4,100 ,c5,400 ,d5s,500 ,e4,150 ,R,10000 ,R,500 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0}
  /* END GAME */              ,{e4,800 ,e3,1200 ,R,5000 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0 ,R,0}
};
...
void loop()
{
  ...
  //Check for message from node 1
  if (last_message != NO_MESSAGE) listenForData();
}
